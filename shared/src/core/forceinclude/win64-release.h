...
// Build definitions
#define __DEBUG					0	// Debug build
#define __PROFILE				0	// Profile build
#define __DEV 					0	// Dev build
#define __ASSERTIONS			0	// Enable assertions
#define __EXCEPTIONS			0	// Enable exceptions

#define __EDITOR				0	// Editor build
#define __TOOL					0	// Tool enabled build
#define __TOOL_CLI				0	// Tool command-line only

#define __RELEASE				1	// Release build
#define __FINAL			 		1	// Final build
#define __OPTIMIZED				1	// Optimized build
